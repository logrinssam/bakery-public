...
export const STAGES: Stage[] = [
  // 1-10 Cookie Shop
  { id: 1, name: '쿠키 상점 1', representativeMenu: '기본 라운드 쿠키', shopType: ShopType.COOKIE, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_cookie.png`, requiredStars: 0, goldMultiplier: 1.0, theme: '기본 비의 성질' },
  { id: 2, name: '쿠키 상점 2', representativeMenu: '버터 쿠키', shopType: ShopType.COOKIE, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_cookie.png`, requiredStars: 3, goldMultiplier: 1.1, theme: '기본 비의 성질' },
  { id: 3, name: '쿠키 상점 3', representativeMenu: '초코칩 쿠키', shopType: ShopType.COOKIE, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_cookie.png`, requiredStars: 6, goldMultiplier: 1.2, theme: '상대적 비의 개념' },
  { id: 4, name: '쿠키 상점 4', representativeMenu: '딸기잼 쿠키', shopType: ShopType.COOKIE, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_cookie.png`, requiredStars: 9, goldMultiplier: 1.3, theme: '기준량과 비교하는 양' },
  { id: 5, name: '쿠키 상점 5', representativeMenu: '바닐라 쿠키', shopType: ShopType.COOKIE, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_cookie.png`, requiredStars: 12, goldMultiplier: 1.4, theme: '비의 문장 표현' },
  { id: 6, name: '쿠키 상점 6', representativeMenu: '시나몬 쿠키', shopType: ShopType.COOKIE, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_cookie.png`, requiredStars: 15, goldMultiplier: 1.5, theme: '기준량 찾기' },
  { id: 7, name: '쿠키 상점 7', representativeMenu: '모양 쿠키', shopType: ShopType.COOKIE, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_cookie.png`, requiredStars: 18, goldMultiplier: 1.6, theme: '비료와 기준값' },
  { id: 8, name: '쿠키 상점 8', representativeMenu: '별 쿠키', shopType: ShopType.COOKIE, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_cookie.png`, requiredStars: 21, goldMultiplier: 1.7, theme: '비교하는 양 찾기' },
  { id: 9, name: '쿠키 상점 9', representativeMenu: '쿠키 박스', shopType: ShopType.COOKIE, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_cookie.png`, requiredStars: 24, goldMultiplier: 1.8, theme: '비의 응용' },
  { id: 10, name: '쿠키 상점 10', representativeMenu: '쿠키 세트', shopType: ShopType.COOKIE, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_cookie.png`, requiredStars: 27, goldMultiplier: 2.0, theme: '비 단원 종합' },

  // 11-15 컵케이크 상점
  { id: 11, name: '컵케이크 상점 1', representativeMenu: '바닐라 컵케이크', shopType: ShopType.CUPCAKE, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_cupcake.png`, requiredStars: 30, goldMultiplier: 2.2, theme: '비율의 기호 표현' },
  { id: 12, name: '컵케이크 상점 2', representativeMenu: '딸기 컵케이크', shopType: ShopType.CUPCAKE, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_cupcake.png`, requiredStars: 33, goldMultiplier: 2.4, theme: '비율을 분수로 나타내기' },
  { id: 13, name: '컵케이크 상점 3', representativeMenu: '초코 컵케이크', shopType: ShopType.CUPCAKE, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_cupcake.png`, requiredStars: 36, goldMultiplier: 2.6, theme: '전체에 대한 부분의 비율' },
  { id: 14, name: '컵케이크 상점 4', representativeMenu: '생크림 컵케이크', shopType: ShopType.CUPCAKE, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_cupcake.png`, requiredStars: 39, goldMultiplier: 2.8, theme: '두 수의 크기 비교 비율' },
  { id: 15, name: '컵케이크 상점 5', representativeMenu: '컵케이크 세트', shopType: ShopType.CUPCAKE, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_cupcake.png`, requiredStars: 42, goldMultiplier: 3.1, theme: '분수 비율 마스터' },

  // 16-20 케이크 상점
  { id: 16, name: '케이크 상점 1', representativeMenu: '생크림 케이크', shopType: ShopType.CAKE, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_cake.png`, requiredStars: 45, goldMultiplier: 3.4, theme: '비율을 소수로 나타내기' },
  { id: 17, name: '케이크 상점 2', representativeMenu: '딸기 케이크', shopType: ShopType.CAKE, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_cake.png`, requiredStars: 48, goldMultiplier: 3.7, theme: '소수 비율 계산' },
  { id: 18, name: '케이크 상점 3', representativeMenu: '초코 케이크', shopType: ShopType.CAKE, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_cake.png`, requiredStars: 51, goldMultiplier: 4.0, theme: '기준량이 100일 때의 비율' },
  { id: 19, name: '케이크 상점 4', representativeMenu: '과일 케이크', shopType: ShopType.CAKE, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_cake.png`, requiredStars: 54, goldMultiplier: 4.4, theme: '실생활 소수 비율 응용' },
  { id: 20, name: '케이크 상점 5', representativeMenu: '케이크 세트', shopType: ShopType.CAKE, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_cake.png`, requiredStars: 57, goldMultiplier: 4.8, theme: '비율 소수 마스터' },

  // 21-25 도넛 상점
  { id: 21, name: '도넛 상점 1', representativeMenu: '기본 도넛', shopType: ShopType.DONUT, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_donut.png`, requiredStars: 60, goldMultiplier: 5.2, theme: '백분율의 의미와 기호' },
  { id: 22, name: '도넛 상점 2', representativeMenu: '글레이즈 도넛', shopType: ShopType.DONUT, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_donut.png`, requiredStars: 63, goldMultiplier: 5.6, theme: '비율을 백분율로 바꾸기' },
  { id: 23, name: '도넛 상점 3', representativeMenu: '초코 도넛', shopType: ShopType.DONUT, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_donut.png`, requiredStars: 66, goldMultiplier: 6.0, theme: '백분율을 소수/분수로 바꾸기' },
  { id: 24, name: '도넛 상점 4', representativeMenu: '스프링클 도넛', shopType: ShopType.DONUT, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_donut.png`, requiredStars: 69, goldMultiplier: 6.5, theme: '전체의 백분율 구하기' },
  { id: 25, name: '도넛 상점 5', representativeMenu: '도넛 박스', shopType: ShopType.DONUT, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_donut.png`, requiredStars: 72, goldMultiplier: 7.0, theme: '백분율 마스터' },

  // 26-30 마카롱 상점
  { id: 26, name: '마카롱 상점 1', representativeMenu: '딸기 마카롱', shopType: ShopType.MACARON, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_macaron.png`, requiredStars: 75, goldMultiplier: 7.6, theme: '백분율로 비교하는 양 구하기' },
  { id: 27, name: '마카롱 상점 2', representativeMenu: '민트 마카롱', shopType: ShopType.MACARON, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_macaron.png`, requiredStars: 78, goldMultiplier: 8.2, theme: '백분율과 실제 수량' },
  { id: 28, name: '마카롱 상점 3', representativeMenu: '초코 마카롱', shopType: ShopType.MACARON, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_macaron.png`, requiredStars: 81, goldMultiplier: 8.8, theme: '비율을 통한 양의 배분' },
  { id: 29, name: '마카롱 상점 4', representativeMenu: '마카롱 박스', shopType: ShopType.MACARON, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_macaron.png`, requiredStars: 84, goldMultiplier: 9.5, theme: '여러 성분의 비율 관계' },
  { id: 30, name: '마카롱 상점 5', representativeMenu: '디저트 세트', shopType: ShopType.MACARON, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_macaron.png`, requiredStars: 87, goldMultiplier: 10.2, theme: '마카롱 비율 마스터' },

  // 31-40 베이커리 팝업
  { id: 31, name: '베이커리 팝업 1', representativeMenu: '할인 쿠키 세트', shopType: ShopType.MARKET, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_market.png`, requiredStars: 90, goldMultiplier: 11.0, theme: '할인율 계산 원리' },
  { id: 32, name: '베이커리 팝업 2', representativeMenu: '할인 케이크', shopType: ShopType.MARKET, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_market.png`, requiredStars: 94, goldMultiplier: 11.8, theme: '인하된 판매가격 구하기' },
  { id: 33, name: '베이커리 팝업 3', representativeMenu: '쿠폰 상품', shopType: ShopType.MARKET, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_market.png`, requiredStars: 98, goldMultiplier: 12.6, theme: '쿠폰 할인가 계산' },
  { id: 34, name: '베이커리 팝업 4', representativeMenu: '세일 빵', shopType: ShopType.MARKET, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_market.png`, requiredStars: 102, goldMultiplier: 13.5, theme: '할인율 역산하기' },
  { id: 35, name: '베이커리 팝업 5', representativeMenu: '세일 세트', shopType: ShopType.MARKET, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_market.png`, requiredStars: 106, goldMultiplier: 14.5, theme: '세트 할인율 비교' },
  { id: 36, name: '베이커리 팝업 6', representativeMenu: '인기 메뉴', shopType: ShopType.MARKET, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_market.png`, requiredStars: 110, goldMultiplier: 15.5, theme: '증가율과 감소율' },
  { id: 37, name: '베이커리 팝업 7', representativeMenu: '재고 상품', shopType: ShopType.MARKET, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_market.png`, requiredStars: 114, goldMultiplier: 16.6, theme: '원가와 할인가 비율' },
  { id: 38, name: '베이커리 팝업 8', representativeMenu: '프리미엄 세트', shopType: ShopType.MARKET, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_market.png`, requiredStars: 118, goldMultiplier: 17.8, theme: '복수 할인 적용' },
  { id: 39, name: '베이커리 팝업 9', representativeMenu: '단골 세트', shopType: ShopType.MARKET, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_market.png`, requiredStars: 122, goldMultiplier: 19.0, theme: '할인 금액과 할인율 관계' },
  { id: 40, name: '베이커리 팝업 10', representativeMenu: '마스터 세트', shopType: ShopType.MARKET, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_market.png`, requiredStars: 126, goldMultiplier: 20.5, theme: '비율과 백분율 마스터' },

  // 41-45 왕실 베이커리
  { id: 41, name: '왕실 베이커리 1', representativeMenu: '왕실 쿠키', shopType: ShopType.ROYAL, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_royal.png`, requiredStars: 130, goldMultiplier: 22.0, theme: '소금물과 시럽 농도 비율' },
  { id: 42, name: '왕실 베이커리 2', representativeMenu: '왕실 케이크', shopType: ShopType.ROYAL, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_royal.png`, requiredStars: 135, goldMultiplier: 23.5, theme: '성분 비율의 혼합 계산' },
  { id: 43, name: '왕실 베이커리 3', representativeMenu: '왕실 도넛', shopType: ShopType.ROYAL, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_royal.png`, requiredStars: 140, goldMultiplier: 25.0, theme: '기준량의 역산' },
  { id: 44, name: '왕실 베이커리 4', representativeMenu: '왕실 마카롱', shopType: ShopType.ROYAL, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_royal.png`, requiredStars: 145, goldMultiplier: 27.0, theme: '전체의 수 추정하기' },
  { id: 45, name: '왕실 베이커리 5', representativeMenu: '황금 레시피', shopType: ShopType.ROYAL, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_royal.png`, requiredStars: 150, goldMultiplier: 30.0, theme: '황금 비율 분배' },

  // 46-50 천재 파티셰 명예의 베이커리
  { id: 46, name: '천재 파티셰 명예의 베이커리 1', representativeMenu: '대회 세트', shopType: ShopType.FINAL, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_final.png`, requiredStars: 155, goldMultiplier: 33.0, theme: '종합 응용 문장제 1' },
  { id: 47, name: '천재 파티셰 명예의 베이커리 2', representativeMenu: '별빛 디저트', shopType: ShopType.FINAL, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_final.png`, requiredStars: 160, goldMultiplier: 36.5, theme: '종합 응용 문장제 2' },
  { id: 48, name: '천재 파티셰 명예의 베이커리 3', representativeMenu: '꿈빛 디저트', shopType: ShopType.FINAL, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_final.png`, requiredStars: 166, goldMultiplier: 40.0, theme: '종합 응용 문장제 3' },
  { id: 49, name: '천재 파티셰 명예의 베이커리 4', representativeMenu: '전설의 빵', shopType: ShopType.FINAL, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_final.png`, requiredStars: 172, goldMultiplier: 45.0, theme: '전설 레시피 비율 탐구' },
  { id: 50, name: '천재 파티셰 명예의 베이커리 5', representativeMenu: '시그니처 빵', shopType: ShopType.FINAL, backgroundImage: `${import.meta.env.BASE_URL}assets/shops/shop_final.png`, requiredStars: 180, goldMultiplier: 50.0, theme: '비와 비율의 마스터 선서' }
];
